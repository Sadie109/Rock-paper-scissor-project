...
#plan of action
#write out if variables
# example of variable js
let playerMove = "rock";
let computerMove = "paper";
#function in whether the move is a draw, lose or win.
# possible variable answer 
   if (playerMove === computerMove) {
    alert ("it's a tie!");
}
else if (playerMove ==="rock") {
  if (computerMove === "paper"){
      alert ("computer won! Tough Luck...");
  }
else alert ("You won! Way to go!!");
}
## Task 2: Function
